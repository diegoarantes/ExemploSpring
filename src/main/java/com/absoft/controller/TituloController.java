...
import com.absoft.model.StatusTitulo;
import com.absoft.model.Titulo;
import com.absoft.repository.Titulos;
...
public class TituloController {
    ...
    public ModelAndView edicao(@PathVariable String id) {
        Titulo titulo = titulos.findById(new ObjectId(id)); //Se for com JPA faz Diferente aula 2.15
